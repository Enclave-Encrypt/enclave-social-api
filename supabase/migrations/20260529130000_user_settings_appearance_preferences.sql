...
drop function if exists public.upsert_my_user_settings(text, text, text, boolean);
...
grant execute on function public.upsert_my_user_settings(text, text, text, jsonb, boolean) to authenticated;
